...
import "./styles/_socialStyles.scss";
...
const Social = () => {
  return (
    ...
    >
      <a
        href="#0"
        className="c-link c-link--facebook c-tooltip"
        aria-label="Facebook"
      >
      ...
      <a
        href="#0"
        className="c-link c-link--twitter c-tooltip"
        aria-label="Twitter"
      >
        <svg className="c-icon">
      ...
      <a
        href="#0"
        className="c-link c-link--instagram c-tooltip"
