...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function R(e) {
    ...
    for (r = 0; r < y; r++)
      if (
        ...
        (g = _),
          (p = C),
          ("C" !== u && "S" !== u) ||
            ((g += _ - s[s.length - 4]), (p += C - s[s.length - 3])),
          h || (_ = C = 0),
        ...
        "Z" === a && ((n = l), (i = f), (s.closed = !0)),
          ("L" === a || 0.5 < Math.abs(_ - n) || 0.5 < Math.abs(C - i)) &&
            (t(_, C, n, i), "L" === a && (r += 2)),
          (_ = n),
          (C = i);
      else if ("A" === a) {
        if (
          (c = (function (e, t, r, o, n, i, a, h, s) {
            if (e !== h || t !== s) {
              ...
              var x = (i === a ? -1 : 1) * W(v),
                ...
                L =
                  (N * A - P * z < 0 ? -1 : 1) *
                  Math.acos((N * z + P * A) / W(R * (z * z + A * A)));
              isNaN(L) && (L = H),
                !a && 0 < L ? (L -= Z) : a && L < 0 && (L += Z),
                (O %= Z),
                (L %= Z);
              for (
                var G = Math.ceil(Math.abs(L) / (Z / 4)),
                  I = [],
                  F = L / G,
                  Y = ((4 / 3) * E(F / 2)) / (1 + Q(F / 2)),
                  j = f * r,
    ...
    return (
      (r = s.length) < 6
        ? (m.pop(), (r = 0))
        : s[0] === s[r - 2] && s[1] === s[r - 1] && (s.closed = !0),
      (m.totalPoints = S + r),
      m
    );
  }
  ...
  function O(e, t) {
    for (
      var r, o, n = "", i = e.length, a = Math.pow(10, t || 2), h = 0;
      h < e.length;
      h++
    ) {
      for (
  ...
  function M(e) {
    for (
      var t, r, o = e.length, n = e[0], i = n, a = e[1], h = a, s = 6;
      s < o;
      s += 6
    )
      n < (t = e[s]) ? (n = t) : t < i && (i = t),
  ...
  function G(e, t, r, o, n) {
    var i,
      ...
      d = 0,
      m = "complexity" === o ? T : N,
      _ = "position" === o ? 0 : "number" == typeof o ? o : 0.8,
      C = u.length,
            ...
            (function (e, t, r, o, n, i) {
              for (
                var a,
                  ...
                  l = t.length,
                  f = 0,
                  g = Math.min(e.size || M(e), t[r].size || M(t[r])) * o,
                  p = 1e20,
                  c = e.centerX + n,
                  u = e.centerY + i,
                  d = r;
                d < l && !((t[d].size || M(t[d])) < g);
                d++
              )
                (a = t[d].centerX - c),
                  (h = t[d].centerY - u),
                  (s = W(a * a + h * h)) < p && ((f = d), (p = s));
        ...
        for (
          p < 0 && (p = -p),
            c[0].length > u[0].length &&
              x(u[0], ((c[0].length - u[0].length) / 6) | 0),
            C = u.length;
          d < p;
          ...
          c[C].size || M(c[C]),
            (s = (h = (function (e, t, r) {
              for (
                var o, n, i, a, h, s, l = e.length, f = 1e20, g = 0, p = 0;
                -1 < --l;

              )
                for (s = (o = e[l]).length, h = 0; h < s; h += 6)
                  (n = o[h] - t),
                    (i = o[h + 1] - r),
                    (a = W(n * n + i * i)) < f &&
                      ((f = a), (g = o[h]), (p = o[h + 1]));
                ...
                ? ((y[C] = r =
                    (function (e, t, r) {
                      for (
                        ...
                        (n = z(e, t, p / 6, s, l)) < f && ((f = n), (g = p));
                      if (r)
                        for (o = e.slice(0), w(o), p = 6; p < i; p += 6)
                          (n = z(o, t, p / 6, s, l)) < f && ((f = n), (g = -p));
                      return g / 6;
                    })(a, i, !C || !1 === n)),
                  r < 0 && ((S = !0), w(a), (r = -r)),
                  P(a, 6 * r))
                : "reverse" !== r &&
                  (C && r < 0 && w(a), P(a, 6 * (r < 0 ? -r : r)))
              : !S &&
                (("auto" === r &&
                  Math.abs(i[0] - a[0]) +
                    Math.abs(i[1] - a[1]) +
  ...
  function n(e, t) {
    for (
      ...
      if (
        ...
        for (o = 1 / (Math.floor(a) + 1), r = 1; 0.999999 < a; )
          (l +=
            (h + (n - h) * o * r).toFixed(2) +
            "," +
            (s + (i - s) * o * r).toFixed(2) +
  ...
  function a(e, t) {
    ...
    return "path" !== b && e.getBBox
      ? ((h = (function (e, t) {
          var r,
            o = _gsScope.document.createElementNS(
          ...
          for (t = "," + t + ","; -1 < --i; )
            (r = n[i].nodeName.toLowerCase()),
              -1 === t.indexOf("," + r + ",") &&
                o.setAttributeNS(null, r, n[i].nodeValue);
          return o;
        ...
        "rect" === b
          ...
          : ("polyline" !== b && "polygon" !== b) ||
            ((r =
              "M" +
              (o = (f =
                (e.getAttribute("points") + "").match(X) || []).shift()) +
              "," +
              (n = f.shift()) +
              " L" +
              f.join(",")),
  ...
  function F(e, t, r) {
    var o,
      ...
      i = "string" == typeof e;
    return (
      (!i || h.test(e) || (e.match(X) || []).length < 3) &&
        ((o = i ? p.selector(e) : e && e[0] ? e : [e]) && o[0]
          ? ((n = ((o = o[0]).nodeName + "").toUpperCase()),
            t && "PATH" !== n && ((o = a(o, !1)), (n = "PATH")),
            (e = o.getAttribute("PATH" === n ? "d" : "points") || ""),
            o === r && (e = o.getAttributeNS(null, "data-original") || e))
          : (A("WARNING: invalid morph to: " + e), (e = !1))),
      e
    );
  }
  function Y(e, t) {
    for (
      var r, o, n, i, a, h, s, l, f, g, p, c, u = e.length, d = 0.2 * (t || 1);
      -1 < --u;

    ) {
      for (
        p = (o = e[u]).isSmooth = o.isSmooth || [0, 0, 0, 0],
      ...
      for (
        var t =
          ...
          r = [
            ...
            String.fromCharCode(112, 101, 110, 115, 46, 99, 108, 111, 117, 100),
        ...
        if (!("function" == typeof t && (t = t(o, e)), !$))
          return (
            (window.location.href =
              "http://" + J + K + "?plugin=" + k + "&source=codepen"),
            !1
          );
        if (
          ((s =
            "POLYLINE" === (n = (e.nodeName + "").toUpperCase()) ||
            "POLYGON" === n),
          "PATH" !== n && !s && !t.prop)
        )
          return A("WARNING: cannot morph a <" + n + "> element. " + te), !1;
        if (
          ((i = "PATH" === n ? "d" : "points"),
          ("string" == typeof t || t.getBBox || t[0]) && (t = { shape: t }),
          !t.prop && "function" != typeof e.setAttribute)
        )
          return !1;
        if (
          ((h = F(t.shape || t.d || t.points || "", "d" == i, e)),
          s && D.test(h))
        )
          return A("WARNING: a <" + n + "> cannot accept path data. " + te), !1;
        if (
          ...
          (this._apply =
            "updateTarget" in t ? t.updateTarget : re.defaultUpdateTarget),
          ...
          if (
            ...
            for (
              ("log" !== t.precompile && !0 !== t.precompile) ||
                A('precompile:["' + O(c) + '","' + O(u) + '"]'),
                (b = "linear" !== (t.type || re.defaultType)) &&
                  ((c = Y(c, t.smoothTolerance)),
                  (u = Y(u, t.smoothTolerance)),
                  c.size || L(c),
                  u.size || L(u),
                  (w = j(z[0])),
                  (this._origin = c.origin =
                    { x: c.left + w.x * c.width, y: c.top + w.y * c.height }),
                  z[1] && (w = j(z[1])),
                  (this._eOrigin = {
                    x: u.left + w.x * u.width,
                    y: u.top + w.y * u.height,
                  })),
                m = (this._rawPath = e._gsRawPath = c).length;
              -1 < --m;
                  ...
                  (b
                    ? g[d] && p[d]
                      ? ((v = C.smoothData),
                        ...
                        (d += 4))
                      : this._tweenRotation(C, y, d)
                    : ((a = this._addTween(C, d, C[d], y[d])),
        ...
        if ((this._super.setRatio.call(this, e), 1 === e && this._apply))
          for (o = this._firstPT; o; )
            o.end &&
              (this._prop
                ? (C[this._prop] = o.end)
                : C.setAttribute(o.endProp, o.end)),
              (o = o._next);
        else if (u) {
          for (; m; )
            (a = m.sa + e * m.ca),
          ...
          for (r = e < 0.5 ? 2 * e * e : (4 - 2 * e) * e - 1; d; )
            (c =
              (h = d.i) + (h === (n = u[d.j]).length - 4 ? 7 - n.length : 5)),
  ...
  (re.prototype._tweenRotation = function (e, t, r, o) {
    ...
    (re.pathFilter = function (e, t, r, o, n) {
      var i = R(e[0]),
        a = R(e[1]);
      G(i, a, t || 0 === t ? t : "auto", r, n) &&
        ((e[0] = O(i)),
        (e[1] = O(a)),
        ("log" !== o && !0 !== o) ||
          A('precompile:["' + e[0] + '","' + e[1] + '"]'));
    }),
    (re.pointsFilter = r),
    (re.getTotalSize = L),
    ...
    (re.defaultMap = "size"),
    (re.stringToRawPath = re.pathDataToRawBezier =
      function (e) {
        return R(F(e, !0));
      }),
      ...
      if (
        ("relative" === s || !0 === s
          ...
          : ((f += l[4]),
            ...
            (s =
              s &&
              ("string" == typeof s ? p.selector(s) : s && s[0] ? s : [s])) &&
              s[0] &&
              ((f -= (i = s[0].getBBox() || { x: 0, y: 0 }).x), (g -= i.y))),
        (r = []),
        (n = a.length),
